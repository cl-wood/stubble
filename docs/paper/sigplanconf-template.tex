...
\title{Approximating Symbolic Execution Using Dynamic Taint Analysis}
...
Current research focuses on carefully deciding when to use symbolic execution [J, CITE]. Such so-called concolic execution mixes concrete and symbolic input, and various heuristics to determine when to resort to symbolic execution are in research [CITE].
