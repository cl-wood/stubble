...
%%% functionality among LaTeX's many packages.  Be aware that some
%%% packages may break some of the formatting features provided by
%%% by 'fsuthesis' class.
...
\semester{Spring}                     %% Graduation Semester:
                                      %%   [Fall, Spring, Summer]
\degreeyear{2012}                     %% Graduation Year
\defensedate{April 6, 2012}           %% Date of Defense
...
%\renewcommand*{\bibname}{Bibliography} % This is the default
