...
TODO MyPinToolMultiProcess, why process level instead of threads, etc.
...
This bears a strong resemblance to the classic oracle attack in cryptography. Note as mentioned above, that stubble would be unable to reason effectively about cryptographic hashes or encryption because of properties like one-way functions and the avalanche effect.
...
TODO instrument C library routines like strcpy and strcmp.
