...
As a demonstration I have run my fuzzer, Stubble, against various binaries which open a file and check specific bytes in a file for specific character values. If all of these checks pass, then AAAAA, otherwise BBBBBB (segfault? EIP? add vulnerability detection alg?). I have observed .... (insert graphs with password lengths, etc.)
...
%Looking like linear with password + constant of 16 overtaint
%Pw len:   Tests: 
%1         17
%4         20
%7         26
