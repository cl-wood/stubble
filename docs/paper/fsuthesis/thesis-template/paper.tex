...
%Because Stubble works at the process level, allowing one run to finish before generating a test file for the next, concurrency seems implementable. However, because 
